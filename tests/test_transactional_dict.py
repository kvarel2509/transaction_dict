...
#     def setUp(self):
#         self.session = Session(transaction_factory=MultiVersionStrategyTransactionFactory(
#             journal_repository=factory.get_journal_repository()
#         ))
#
#     def
...
#
# '''2'''
# with engine.transaction(isolation_level='dsdasd') as transaction:
#     ...
#     transaction.commit()
#
# '''3'''
...
# '''4'''
# session = engine.connect()
# session.open_transaction(isolation_level='dsdasd')
# session.open_transaction(isolation_level='dsdasd')
...
#
# with engine.connect() as session:
#     with session.open_transaction(isolation_level='dsdasd'):
#         session[key] = value
#         session.commit()
